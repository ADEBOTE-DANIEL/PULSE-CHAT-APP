...
if os.getenv('CORS_ALLOW_ALL') == 'True' and DEBUG:
...
# Database
# Local development uses SQLite for simplicity (no server to install/run).
# Production (Render) uses PostgreSQL automatically via DATABASE_URL.
